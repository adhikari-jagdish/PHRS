...
import com.vayamtech.healthe_cord.Fragment.DiagnosticInvestigation_oneFragment;
...
public class DiagnosticInvestigationActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diagnostic_investigation);
        ...
        title.setText("Diagnostic Investigation");

        //Navigation Drawer Start
        drawerLayout = findViewById(R.id.DiagnosticInvestigation_drawerlayout);
